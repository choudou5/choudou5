 ...
 * @Date：2018-03-08
 */
public class LoggerInfo implements Serializable, Comparable<com.choudou5.log.admin.LoggerInfo>  {
    ...
    @Override
    public int compareTo(com.choudou5.log.admin.LoggerInfo other) {
