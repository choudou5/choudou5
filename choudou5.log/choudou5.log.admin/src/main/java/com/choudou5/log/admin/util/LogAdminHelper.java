package com.choudou5.log.admin.util;
...
public class LogAdminHelper {
    ...
    private static com.choudou5.log.admin.LogWatcher watcher;

    private LogAdminHelper() {
    }

    public static void setWatcher(com.choudou5.log.admin.LogWatcher logWatcher) {
        if(watcher != null)
    ...
    public static Map getLogListInfo() {
        ...
        List<com.choudou5.log.admin.LoggerInfo> loggers = new ArrayList<>(watcher.getAllLoggers());
        Collections.sort(loggers);
        List<com.choudou5.log.admin.LoggerInfo> infos = new ArrayList<>();
        for(com.choudou5.log.admin.LoggerInfo info:loggers) {
            infos.add(info);
        }
