 ...
 */
public class CorpCalendarCreateRequest extends BaseDingTalkRequest<CorpCalendarCreateResponse> {
	...
	* 创建日程实体
	...
	public static class OpenCalendarReminderVo extends TaobaoObject {
		private static final long serialVersionUID = 6794363527826323419L;
		/**
		 * 距开始时多久进行提醒(单位:分钟)
		 */
		@ApiField("minutes")
	...
	public static class DatetimeVo extends TaobaoObject {
		private static final long serialVersionUID = 5229726211443887418L;
		/**
		 * 时区
		 */
		@ApiField("timezone")
	...
	public static class OpenCalendarSourceVo extends TaobaoObject {
		private static final long serialVersionUID = 7412393754325223478L;
		/**
		 * 日程来源
		 */
		@ApiField("title")
	...
	public static class OpenCalendarCreateVo extends TaobaoObject {
		private static final long serialVersionUID = 3591218265632232457L;
		/**
		 * 业务方自己的主键
		 */
		@ApiField("biz_id")
