 ...
 */
public class CorpChatbotInstallRequest extends BaseDingTalkRequest<CorpChatbotInstallResponse> {
	...
	* 安装的机器人信息
	...
	public static class ChatbotVo extends TaobaoObject {
		private static final long serialVersionUID = 6558489611373852335L;
		/**
		 * 0-正常，1-只服务端可管理
		 */
		@ApiField("authority")
