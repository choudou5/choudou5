...
/**
 * TOP DingTalk-API: dingtalk.smartwork.bpms.process.copy request
 * 
 * @author top auto create
 * @since 1.0, 2017.06.14
 */
public class SmartworkBpmsProcessCopyRequest extends BaseDingTalkRequest<SmartworkBpmsProcessCopyResponse> {
	...
	* 审批流名称
	...
	public Class<SmartworkBpmsProcessCopyResponse> getResponseClass() {
		return SmartworkBpmsProcessCopyResponse.class;
	}
