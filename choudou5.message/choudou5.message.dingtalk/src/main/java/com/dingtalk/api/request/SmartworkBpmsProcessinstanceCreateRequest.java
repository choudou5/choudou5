 ...
 */
public class SmartworkBpmsProcessinstanceCreateRequest extends BaseDingTalkRequest<SmartworkBpmsProcessinstanceCreateResponse> {
	...
	* 审批流的唯一码
	...
	public static class FormComponentValueVo extends TaobaoObject {
		private static final long serialVersionUID = 1536716767723463783L;
		/**
		 * 扩展值
		 */
		@ApiField("ext_value")
