 ...
 * @since 1.0, null
 */
public class CorpHealthStepinfoListResponse extends DingTalkResponse {

	private static final long serialVersionUID = 6871813642731772486L;
	...
	public static class BasicStepInfoVo extends TaobaoObject {
		private static final long serialVersionUID = 5383673284845744633L;
		/**
		 * 统计的时间
		 */
		@ApiField("stat_date")
	...
	public static class DingOpenResult extends TaobaoObject {
		private static final long serialVersionUID = 5335424826527282319L;
		/**
		 * dingOpenErrcode
		 */
