 ...
 * @since 1.0, null
 */
public class CorpMessageCorpconversationGetsendresultResponse extends DingTalkResponse {

	private static final long serialVersionUID = 6828877416937241539L;
	...
	public static class AsyncSendResult extends TaobaoObject {
		private static final long serialVersionUID = 8565692195493572239L;
		/**
		 * 发送失败的用户id
		 */
	...
	public static class DingOpenResult extends TaobaoObject {
		private static final long serialVersionUID = 1442227411686911189L;
		/**
		 * dingOpenErrcode
		 */
