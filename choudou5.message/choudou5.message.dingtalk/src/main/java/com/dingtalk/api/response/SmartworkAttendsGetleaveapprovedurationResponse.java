 ...
 * @since 1.0, null
 */
public class SmartworkAttendsGetleaveapprovedurationResponse extends DingTalkResponse {

	private static final long serialVersionUID = 3877971452418538762L;
	...
	public static class ApproveDurationForTopVo extends TaobaoObject {
		private static final long serialVersionUID = 5813121874275749293L;
		/**
		 * 请假时长（单位分钟）
		 */
	...
	public static class DingOpenResult extends TaobaoObject {
		private static final long serialVersionUID = 8611517633148582251L;
		/**
		 * dingOpenErrcode
		 */
