 ...
 * @since 1.0, null
 */
public class SmartworkBlackboardListtoptenResponse extends DingTalkResponse {

	private static final long serialVersionUID = 1246432156372396574L;
	...
	public static class OapiBlackboardVo extends TaobaoObject {
		private static final long serialVersionUID = 4547256635672212736L;
		/**
		 * 创建时间
		 */
		@ApiField("gmt_create")
	...
	public static class DingOpenResult extends TaobaoObject {
		private static final long serialVersionUID = 6275982645572642363L;
		/**
		 * result
		 */
