 ...
 */
public class CorpExtcontactCreateRequest extends BaseDingTalkRequest<CorpExtcontactCreateResponse> {
	...
	* 外部联系人信息
	...
	public static class OpenExtContact extends TaobaoObject {
		private static final long serialVersionUID = 8817486823869925519L;
		/**
		 * 地址
		 */
		@ApiField("address")
