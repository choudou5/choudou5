 ...
 */
public class CorpExtcontactUpdateRequest extends BaseDingTalkRequest<CorpExtcontactUpdateResponse> {
	...
	* 外部联系人信息
	...
	public static class OpenExtContact extends TaobaoObject {
		private static final long serialVersionUID = 6328973282254487992L;
		/**
		 * 地址
		 */
		@ApiField("address")
