 ...
 */
public class CorpSmartdeviceAddfaceRequest extends BaseDingTalkRequest<CorpSmartdeviceAddfaceResponse> {
	...
	* 识别用户数据
	...
	public static class DidoFaceVO extends TaobaoObject {
		private static final long serialVersionUID = 3159242613173483323L;
		/**
