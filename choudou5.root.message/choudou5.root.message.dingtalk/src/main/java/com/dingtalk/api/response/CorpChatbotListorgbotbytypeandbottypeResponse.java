 ...
 * @since 1.0, null
 */
public class CorpChatbotListorgbotbytypeandbottypeResponse extends DingTalkResponse {

	private static final long serialVersionUID = 3487757786327539139L;
	...
	public static class ChatbotModel extends TaobaoObject {
		private static final long serialVersionUID = 6252169283156315987L;
		/**
		 * 机器人类型
		 */
		@ApiField("bot_type")
	...
	public static class DingOpenResult extends TaobaoObject {
		private static final long serialVersionUID = 5499983594518266364L;
		/**
		 * dingOpenErrcode
		 */
