 ...
 * @since 1.0, null
 */
public class CorpMessageCorpconversationGetsendprogressResponse extends DingTalkResponse {

	private static final long serialVersionUID = 3331838684193798458L;
	...
	public static class AsyncSendProgress extends TaobaoObject {
		private static final long serialVersionUID = 1654764987531453693L;
		/**
		 * 取值 0-100，表示处理的百分比
		 */
	...
	public static class DingOpenResult extends TaobaoObject {
		private static final long serialVersionUID = 2673917643948857852L;
		/**
		 * dingOpenErrcode
		 */
